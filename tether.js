...
caffeine.instructionsBase = 0x70000000
caffeine.otherMarkerBase = 0x60000001
caffeine.smallIntegerTagBase = 0x40000000
caffeine.classTagsBase = 0x20000000
caffeine.classes = new Map()
caffeine.tags = new Map()

caffeine.tags.set('trueTag', 0x20000001)
caffeine.tags.set('falseTag', 0x20000002)
caffeine.tags.set('nilTag', 0x20000003)
caffeine.tags.set('stringTag', 0x20000005)
caffeine.tags.set('symbolTag', 0x20000004)
caffeine.tags.set('arrayTag', 0x20000008)
caffeine.tags.set('byteArrayTag', 0x2000000B)
caffeine.tags.set('tetherTag', 0x20000007)
caffeine.tags.set('uuidTag', 0x20000011)
caffeine.tags.set('answerTag', 0x2000001D)
